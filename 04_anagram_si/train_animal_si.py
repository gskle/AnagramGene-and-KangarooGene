"""Train the animal single-input (SI) transfer model.

The animal SI head uses one convolution with kernel size 5 followed by ReLU,
max pooling and dropout. The animal paired-input encoder is fine-tuned
together with the head.

Usage:
    python train_animal_si.py [fold]
"""
...
DATA_CSV = "/data1/lty/intron_pred/data/animal14_intronshuffle.csv"
MODEL_DIR = "/data1/lty/intron_pred/new_model/final_model"
PI_PREFIX = "animal14spe_30wbp_group"
SI_PREFIX = "animal14spe_1input_30wbp_group"
