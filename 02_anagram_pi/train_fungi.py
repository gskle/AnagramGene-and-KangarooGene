"""Train the fungi paired-input AnagramGene model on all five folds.

The fungi model uses the short-sequence encoder (up to 5 kb). 

Usage:
    python train_fungi.py [test_fold]
"""
...
DATA_CSV = "/data1/lty/intron_pred/data/fungi6_intronshuffle.csv"
MODEL_DIR = "/data1/lty/intron_pred/new_model/final_model"
MODEL_PREFIX = "fungi7spe_5kbp_group"
