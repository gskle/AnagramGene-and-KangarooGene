"""Train the animal paired-input AnagramGene model on all five folds.

The animal model uses the long-sequence encoder (up to 300 kb).

Usage:
    python train_animal.py [test_fold]
"""
...
MODEL_PREFIX = "animal14spe_30wbp_group"
